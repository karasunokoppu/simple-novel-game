...
pub fn pause_scene_plugin(app: &mut App) {
    app.init_state::<PauseState>()
        ...
        .add_systems(
            OnEnter(PauseButtonState::Pressed),
            (pause02::flip_to_pause_node, pause01::flip_ui_to_not_visible),
        )
        .add_systems(
            OnEnter(PauseButtonState::NotPressed),
        ...
        .add_systems(OnExit(InGameState::Draw), despawn_screen::<OnPause>);
}
